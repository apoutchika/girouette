...
class Project extends React.Component {
  ...
  render() {
    const {
      group, domains, scheme, favorites, switchFavorite,
    } = this.props;
    return (
      <li
        className={`project-card ${this.state.off && 'is-stop'} ${
      ...
      >
        <div className="project-card__header">
          ...
          {group !== 'Girouette' && (
            <button type="button" className="project-card__power" onClick={this.off}>
              <SVG icon="power" />
            </button>
          )}
        </div>
